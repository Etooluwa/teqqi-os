...
export default function Home() {
  ...
  async function runDiscovery(event: FormEvent<HTMLFormElement>) {
    ...
    setError(null);
    try {
      const response = await fetch("/api/businesses/search", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ industry, location, maxResults }) });
